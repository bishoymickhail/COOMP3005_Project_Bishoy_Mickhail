...
public class Owner {
    ...
    Scanner option = new Scanner(System.in); //scan for ints
    DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    LocalDateTime now = LocalDateTime.now();


    public Owner(Statement s,Connection c, String uN){
        statement = s;
        connection = c;
        userName = uN;
    }
    ...
    public void addBooks(int ISBN, int numBooks){
        ...
        try  {
            ...
            if(result.next()){
                ...
                System.out.println("\nWhat is the ISBN of the book you want to add to the store (7 digits)? (*Required*)");
                ...
                int amount = input.nextInt();
                input.nextLine();
                System.out.println("\nHow many books must be sold before an automatic purchase for more is done (aka Threshold)? (*REQUIRED*) ");
                int threshold = input.nextInt();
                input.nextLine();
                System.out.println("\nWhat is the publisher's name?");
                String pub_name = input.nextLine();
                System.out.println("\nWhat will be this publisher's 7 digit ID number be? (*Required*)");
                int pub_id = input.nextInt();
                System.out.println("\nWhat is the publisher's fee for this book? (*Required*) ");
                ...
                System.out.println("\nWhat is the publisher's 7 digit bank account number for payment purposes? (*REQUIRED*) ");
